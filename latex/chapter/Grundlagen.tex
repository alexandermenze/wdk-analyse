...
Klassen in OrientDB sind Strukturinformationen über die einzupflegenden Daten. Datensätze in der Datenbank müssen zwingend in eine Klasse eingeordnet werden. Je nach gewählter Strukturierung kann den Klassen ein Schema in Form von Eigenschaften und Datentypen zugeordnet werden. Dies ist optional, kann aber auch  teilweise
